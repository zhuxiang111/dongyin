...
// File: contracts/interfaces/IHauntedAsset.sol

pragma solidity ^0.6.0;

interface IHauntedAsset {
...
/**
 * @title Haunted Cash Treasury contract
 * @notice Monetary policy logic to adjust supplies of haunted cash assets
...
contract Treasury is ContractGuard, Epoch {
    ...
    modifier checkOperator {
        require(
            IHauntedAsset(cash).operator() == address(this) &&
                IHauntedAsset(bond).operator() == address(this) &&
                IHauntedAsset(share).operator() == address(this) &&
        ...
        updatePrice
    {
        ...
        IHauntedAsset(cash).burnFrom(msg.sender, amount);
        IHauntedAsset(bond).mint(msg.sender, amount.mul(1e18).div(cashPrice));
        ...
        updatePrice
    {
        ...
        IHauntedAsset(bond).burnFrom(msg.sender, amount);
        ...
        checkOperator
    {
        ...
        IHauntedAsset(cash).mint(address(this), seigniorage);
